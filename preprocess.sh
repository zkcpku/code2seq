...
TRAIN_DIR=/home/zhangkechi/workspace/code2seq-master/data/old_java-small/training
VAL_DIR=/home/zhangkechi/workspace/code2seq-master/data/old_java-small/validation
TEST_DIR=/home/zhangkechi/workspace/code2seq-master/data/old_java-small/test
DATASET_NAME=my_dataset_javasmall
...
EXTRACTOR_JAR=JavaExtractor/JPredict/target/JavaExtractor-new.jar

mkdir -p data
mkdir -p data/${DATASET_NAME}

echo "Extracting paths from validation set..."
${PYTHON} JavaExtractor/extract.py --dir ${VAL_DIR} --max_path_length 1000 --max_path_width 5 --num_threads ${NUM_THREADS} --jar ${EXTRACTOR_JAR} > ${VAL_DATA_FILE} 2>> error_log.txt
echo "Finished extracting paths from validation set"
echo "Extracting paths from test set..."
${PYTHON} JavaExtractor/extract.py --dir ${TEST_DIR} --max_path_length 1000 --max_path_width 5 --num_threads ${NUM_THREADS} --jar ${EXTRACTOR_JAR} > ${TEST_DATA_FILE} 2>> error_log.txt
echo "Finished extracting paths from test set"
echo "Extracting paths from training set..."
${PYTHON} JavaExtractor/extract.py --dir ${TRAIN_DIR} --max_path_length 1000 --max_path_width 5 --num_threads ${NUM_THREADS} --jar ${EXTRACTOR_JAR} | shuf > ${TRAIN_DATA_FILE} 2>> error_log.txt
